...
import kotlinx.android.synthetic.main.btm_navigation_cell.view.*
...
@Suppress("unused")
class BottomBarAnimationCell : RelativeLayout, LayoutContainer {
    ...
    private fun initializeView() {
        allowDraw = true
        containerView = LayoutInflater.from(context).inflate(R.layout.btm_navigation_cell, this)
        draw()
    }
